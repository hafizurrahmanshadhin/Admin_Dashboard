                    ...
                    return (
                        ...
                        (e.prototype._onBlur = function (e) {
                            ...
                            if (
                                ...
                                var r = this._store.activeItems.some(
                                    function (e) {
                                        return e.highlighted;
                                    }
                                );
                    ...
                    return (
                        ...
                        (e.prototype._animateScroll = function (e, t) {
                            var i = this,
                                ...
                                o = !1;
                            t > 0
                                ? (this._scrollDown(s, r, e),
                                    s < e && (o = !0))
                                : (this._scrollUp(s, r, e),
                                    s > e && (o = !0)),
                                o &&
                                requestAnimationFrame(function () {
        ...
        221: function (e, t, i) {
            ...
            function d(e) {
                ...
                if (r(e) || n(e)) (s = e), (t = p(e)), (i = f(e));
                    ...
                    if (
                        ((s = n),
                            h.call(e, "weight") && ((o = e.weight), o <= 0))
                    )
                        throw new Error(
                            ((e) =>
                    ...
                    this.keys.forEach((t, s) => {
                        ...
                        if (a(o))
                            if (n(o)) {
                                let e = [];
                                const t = [
                                    { nestedArrIndex: -1, value: o },
                                ];
                                for (; t.length;) {
                                    const { nestedArrIndex: i, value: s } =
                                        t.pop();
                                    if (a(s))
                                        if (r(s) && !c(s)) {
                                            let t = {
                    ...
                    const t = F(e, this.options),
                        i = (e, t, n) => {
                            if (!e.children) {
                                ...
                                return s && s.length
                                    ? [{ idx: n, item: t, matches: s }]
                                    : [];
                            }
                            const r = [];
                            for (
                                let s = 0, o = e.children.length;
                                s < o;
                                s += 1
                            ) {

            ...
            init: function (t) {
                return (
                    ...
                    (this.options.duration =
                        0 === t.duration
                            ? 0
                            : t.duration || o.defaults.duration),
                    (this.options.selector =
                        t.selector || o.defaults.selector),
                    (this.options.callback =
                        t.callback || o.defaults.callback),
                    ...
                    (this.options.position =
                        t.position || o.defaults.position),
                    ...
                    (this.options.ariaLive =
                        t.ariaLive || o.defaults.ariaLive),

        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                    "backend/images/flags/us.svg")
                : "sp" == e
                    ? (document.getElementById("header-lang-img").src =
                        "backend/images/flags/spain.svg")
                    : "gr" == e
                        ? (document.getElementById("header-lang-img").src =
                            "backend/images/flags/germany.svg")
                        : "it" == e
                            ? (document.getElementById("header-lang-img").src =
                                "backend/images/flags/italy.svg")
                            : "ru" == e
                                ? (document.getElementById("header-lang-img").src =
                                    "backend/images/flags/russia.svg")
                                : "ch" == e
                                    ? (document.getElementById("header-lang-img").src =
                                        "backend/images/flags/china.svg")
                                    : "fr" == e
                                        ? (document.getElementById("header-lang-img").src =
                                            "backend/images/flags/french.svg")
                                        : "ar" == e &&
                                        (document.getElementById("header-lang-img").src =
                                            "backend/images/flags/ae.svg"),
        ...
        !t ||
            ...
            (document.querySelector(".navbar-menu") &&
                ...
                ((n = document.createElement("ul")).innerHTML =
                    '<a href="#" class="logo"><img src="backend/images/logo-sm.png" alt="" height="22"></a>'),
                Array.from(
                    document
        ...
        Array.from(
            ...
            0 < e.querySelectorAll(".notification-item").length
                ...
                : (e.querySelector(".view-all") &&
                    ...
                    (e.innerHTML +=
                        '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<img src="backend/images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'));
        });
    }
    function W() {
        var e;
